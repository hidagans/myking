...
if (!text) return m.reply(`*Teks salah.*`) 
await delay(5 * 5000)
...
await m.reply(`✅ *PESAN BERHASIL TERKIRIM* `)

} catch (e) {
await conn.sendButton(m.chat, `\n${wm}`, lenguajeGB['smsMalError3']() + '#report ' + usedPrefix + command, null, [[lenguajeGB.smsMensError1(), `#lapor ${lenguajeGB['smsMensError2']()} *${usedPrefix + command}*`]], m)
console.log(`❗❗ ${lenguajeGB['smsMensError2']()} ${usedPrefix + command} ❗❗`)
console.log(e)

} else {
await m.reply('```ANDA TIDAK BERWENANG UNTUK MENGGUNAKAN PERINTAH INI.```')}
}
