...
const smsLista1 = () => { return `🌟 INFORMASI MajestyBot 🌟`}
...
const smsLista7 = () => { return `🐈 PASANG MajestyBot 🐈`}
...
//_allantilink.js
const smsTextoYT = () => { return '😻 MajestyBot - WhatsApp '}
...
const eMajestyCoins = () => { return '🐱 MajestyCoins' }
const eGataTickers = () => { return '🎫 Majesty Tickers' } 
...
const smsModP2 = () => { return `Aktifkan fungsi agar semua orang dapat menggunakan MajestyBot`}
const smsModAd1 = () => { return `🛂 MODE ADMIN`}
const smsModAd2 = () => { return `Hanya Admin yang dapat menggunakan MajestyBot di Grup`}
...
//propietario(a).js
const smsJoin = (user) => { return `${packname}\n𝙀𝙎 𝙐𝙉 𝘽𝙊𝙏 𝘿𝙀 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋 𝙌𝙐𝙀 𝙏𝙀 𝘼𝙔𝙐𝘿𝘼𝙍𝘼 𝙍𝙀𝘼𝙇𝙄𝙕𝘼𝙍 𝘿𝙄𝙁𝙀𝙍𝙀𝙉𝙏𝙀𝙎 𝘼𝘾𝙏𝙄𝙑𝙄𝘿𝘼𝘿𝙀𝙎 🪄 𝘼𝙇 𝙋𝙍𝙄𝙑𝘼𝘿𝙊 𝙊 𝙂𝙍𝙐𝙋𝙊 𝙔 𝙏𝘼𝙈𝘽𝙄𝙀𝙉 𝙏𝙀 𝙑𝘼𝙎 𝘼 𝘿𝙄𝙑𝙀𝙍𝙏𝙄𝙍 🎈 𝘾𝙊𝙉 𝙎𝙐𝙎 𝙈𝙐𝙇𝙏𝙄𝙋𝙇𝙀𝙎 𝙁𝙐𝙉𝘾𝙄𝙊𝙉𝙀𝙎, 𝘿𝙄𝙎𝙁𝙍𝙐𝙏𝘼 𝘿𝙀 MajestyBot�!!! 😸\n\n💖 MajestyBot� 𝙁𝙐𝙀 𝙄𝙉𝙑𝙄𝙏𝘼𝘿𝘼 𝙋𝙊𝙍:\n@${user}`}
...
const smsJBPrincipal = () => { return `「🤖 MajestyBot 🤖」*\n\n*⚠️ Anda tidak dapat membuat bot di dalam sub bot.!*\n*✳️ Kirimkan perintah #jadibot ke nomor resmi/utama Bot.*\n\n`}
...
const smsContacto4 = () => { return 'Kontak Resmi MajestyBot 🐈'}
...
smsIniJadi, smsIniJadi2, smsSoloOwnerJB, smsJBPrincipal, smsJBConexion, smsJBConexionClose, smsJBConexionTrue, smsJBConexionTrue2, smsJBCargando, smsJBInfo1, smsJBInfo2, smsJBDel, smsJBAdios, 
