...
const eGataCoins = () => { return '🐱 MajestyCoins' }
...
const smsJBConexionClose2 = () => { return `${lenguajeGB['smsAvisoFG']()}🔴 *KONEKSI TELAH DITUTUP, ANDA HARUS MENGHUBUNGKAN SECARA MANUAL MENGGUNAKAN #jadibot PERINTAH DAN PINDAI ULANG KODE QR BARU*`}
const smsJBConexionClose = () => { return `⚠️ *KONEKSI TELAH DITUTUP, ANDA HARUS TERHUBUNG SECARA MANUAL MENGGUNAKAN PERINTAH #serbot DAN PINDAI ULANG KODE QR BARU*`}
